...
Current works
======
My thesis focuses on crop irrigation decision support tools based on the optimization of analytical and numerical models, in a context of climate change and preservation of water resources. The motivation is to provide a real-time decision, integrating seasonal management constraints and weather uncertainties. I consider a double modeling approach that relies on investigating a mathematical model on which I develop results from optimal control theory, and interacting with the numerical model Optirrig for operational purposes.
